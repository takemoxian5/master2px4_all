...
//  ccr1 = TimerPeriod / 2;  //å ç©ºæ¯”1/2 = 50%
  ccr2 = INIT_DUTY;  //å ç©ºæ¯”1/3 = 33%
  ccr3 = INIT_DUTY;  //å ç©ºæ¯”1/4 = 25%
  ccr1 = INIT_DUTY;  //å ç©ºæ¯”1/3 = 33%
  ccr4 = INIT_DUTY;  //å ç©ºæ¯”1/4 = 25%
//  ccr4 = TimerPeriod / 5;  //å ç©ºæ¯”1/5 = 20%
...
//  TIM_TimeBaseInitStructure.TIM_Period = TimerPeriod - 1;    //Period = (TIM counter clock / TIM output clock) - 1 = 20K  50US
  ...
  TIM_OCInitStructure.TIM_OCNPolarity = TIM_OCNPolarity_Low;// TIM_OCPolarity_High;//è¾“å‡ºåŒç›¸ï¼ŒTIM_OCNPolarity_Highæ—¶è¾“å‡ºåç›¸
